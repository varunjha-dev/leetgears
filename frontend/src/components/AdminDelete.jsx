...
const AdminDelete = () => {
  ...
  // Fixed: Case-insensitive comparison for difficulty filter
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>
                  Review and remove problems from the platform
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={`card shadow-xl rounded-lg p-6 mb-6 ${
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              {/* Difficulty Filter - FIXED: Changed to lowercase values */}
              <select
              ...
              {selectedProblems.size > 0 && (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-green-500 font-bold text-lg">{selectedProblems.size}</span>
                  </div>
                  <button
                    onClick={() => openDeleteModal()}
                    className="ml-auto px-5 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium shadow-lg flex items-center gap-2"
                  >
